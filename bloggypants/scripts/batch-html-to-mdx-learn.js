...
const config = {
  ...
  targetRoot: "/Users/svetaco/Documents/Astro-my/src/content/learn/dirty",
  categories: ["learn"],
...
function createSlug(url) {
  ...
  // Убираем /learn/ из начала пути
  const cleanPath = pathname.replace(/^\/learn\//, "");
...
async function processFile(filePath) {
  ...
  const url = `https://tetrate.io/learn/${relativePath.replace(
    /\/index\.html$/,
    ""
  )}`;
...
// основная функция
async function main() {
  console.log("🚀 Starting learn HTML to MDX conversion...");
  ...
  console.log("\n🎉 Learn HTML to MDX conversion completed!");
  console.log(`\nNext steps:`);
  console.log(`1. Review the generated files in: ${config.targetRoot}`);
  console.log(`2. Run: node src/content/clean-learn.mjs`);
  console.log(
