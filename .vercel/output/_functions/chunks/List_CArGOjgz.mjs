...
import { a as $$Picture, e as $$Icon, $ as $$Grid } from './Grid_BtOugKBn.mjs';
import clsx from 'clsx';
import { s as slugify, A as ArrowLeft, a as ArrowRight, N as Noposts } from './arrow-left_D0egb_vI.mjs';
import { $ as $$Figure } from './_astro_content_Co6I3m48.mjs';
...
</p> </div>` : null} <div data-pagination-wrapper> ${totalPages > 1 && renderTemplate`${renderComponent($$result2, "Pagination", $$Pagination, { "data-pagination": true, "currentPage": currentPage, "totalPages": totalPages, "baseUrl": baseUrl })}`} </div> </div> </div> </div> ` })}`;
