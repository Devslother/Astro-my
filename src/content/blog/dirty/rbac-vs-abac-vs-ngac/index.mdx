...
## [](#why-you-should-choose-ngac-as-your-access-control-model)Why You Should Choose NGAC as Your Access Control Model
...
## [](#what-is-ngac)What Is NGAC?

NGAC, or Next Generation Access Control, takes the approach of modeling access decision data as a graph. NGAC enables a systematic, policy-consistent approach to access control, granting or denying users administrative capabilities with a high level of granularity. NGAC was developed by [NIST](https://www.nist.gov/) (National Institute of Standards and Technology) and is currently used in Tetrate Q and [Tetrate Service Bridge](/tetrate-service-bridge/).
...
NIST’s David Ferraiolo and [Tetrate](/?utm_content=inline-mention)‘s Ignasi Barrera shared how NGAC works at their [presentation](https://youtu.be/FUyXIzm7xbg) on Next Generation Access Control at Service Mesh Day 2019 in San Francisco.
...
![Post Image](https://cdn.thenewstack.io/media/2021/02/079543ac-image4.png)
...
![Post Image](https://cdn.thenewstack.io/media/2021/02/fee707cf-image2.png)
...
## [](#why-choose-ngac)Why Choose NGAC?
...
When access decisions are complex, the processing times of ABAC can rise exponentially. RBAC becomes especially hard to manage at scale, while NGAC scales linearly.
...
![ABAC Vs RBAC Vs NGAC](https://cdn.thenewstack.io/media/2021/02/47409303-screen-shot-2021-02-18-at-7.00.55-am.png)

ABAC Vs RBAC Vs NGAC
...
*   [Unpacking Next Generation Access Control and Tetrate Q](/blog/rbac-vs-abac-vs-ngac/)