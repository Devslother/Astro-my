...
### [](#geneve-vs-vxlan)Geneve vs. VXLAN
...
![Post Image](/.netlify/images?url=_astro%2Fimage-68-1024x379.B8oqZS1z.png&w=1024&h=379&q=100)

Figure 1: Figure 1: VXLAN and Geneve packet format schematic diagram.
...
## [](#why-choose-geneve)Why Choose Geneve?
...
## [](#how-istio-ambient-mesh-applies-geneve-tunnels)How Istio Ambient Mesh Applies Geneve Tunnels

In the [previous blog](/blog/transparent-traffic-intercepting-and-routing-in-the-l4-network-of-istio-ambient-mesh/), I explained how Istio Ambient Mesh uses Ztunnel to implement L4 proxies and Figure 2 shows the L4 transparent traffic interception path using iptables and Geneve tunnels.

![Post Image](/.netlify/images?url=_astro%2Fimage-69-1024x588.BBF4BqFo.png&w=1024&h=588&q=100)

Figure 3: Figure 2: L4 Transparent Traffic Interception Path Using Iptables and Geneve Tunnels.
...
![Post Image](/.netlify/images?url=_astro%2Fimage-70-1024x499.Gqur1ofF.png&w=1024&h=499&q=100)

Figure 4: Figure 3: Intercepting the Traffic of Application Using eBPF.
...
*   [Open vSwitch Geneve(8) man page](https://www.mankier.com/package/openvswitch#System_Administration)
