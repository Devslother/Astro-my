---
title: "Apache SkyWalking: v6 is service-mesh ready"
...
## [](#skywalking-history)**SkyWalking history**

Launched in China by Wu Sheng in 2015, SkyWalking started as just a distributed tracing system, like Zipkin, but with auto instrumentation from a Java agent. This enabled JVM users to see distributed traces without any change to their source code. In the last two years, it has been used for research and production by more than [50 companies](https://skywalking.apache.org/users/). With its expanded capabilities, we expect to see it adopted more globally.
...
## [](#observability-analysis-platform)**Observability analysis platform**
...
*   Its agents support various popular software technologies and frameworks like Tomcat, Spring, Kafka.
...
There are two kinds of **probes**: \* Language agents or SDKs following SkyWalking across-thread propagation formats and trace formats, run in the user’s application process. \* The Istio mixer adaptor, which collects telemetry from the Service Mesh.
...
2.  Consistent visualization in Service Mesh and no mesh.
3.  Topology discovery, Service dependency analysis.
...
2.  H2 storage implementor is back.
3.  Kubernetes cluster management is provided. You don’t need Zookeeper to keep the backend running in cluster mode.
4.  Totally new alarm core. Easier configuration.
5.  More cloud native style.
6.  MySQL will be supported in the next release.

### [](#please-test-and-provide-feedback)**Please! Test and provide feedback!**

We would love everyone to try to test our new version. You can find everything you need in our [Apache repository](https://github.com/apache/skywalking),read the [document](https://github.com/apache/skywalking/blob/master/docs/README.md) for further details. You can contact the project team through the following channels:

*   Submit an issue on [GitHub repository](https://github.com/apache/incubator-skywalking/issues/new)
*   Mailing list: [dev@skywalking.apache.org](mailto:dev@skywalking.apache.org) . Send to [dev-subscribe@kywalking.apache.org](mailto:dev-subscribe@kywalking.apache.org) to subscribe the mail list.
*   [Gitter](https://gitter.im/OpenSkyWalking/Lobby)
*   [Project twitter](https://twitter.com/ASFSkyWalking)

Oh, and one last thing! If you like our project, don’t forget to [give us a star on GitHub](https://github.com/apache/skywalking)