...
description: "The Kubernetes Gateway API, aka \"Gateway API\", is a Kubernetes API specification defining a standard way to configure and manage application traffic routing in Kubernetes clusters."
categories: ["learn"]
excerpt: "The Kubernetes Gateway API, aka \"Gateway API\", is a Kubernetes API specification defining a standard way to configure and manage application traffic routing in Kubernetes clusters."
---
...
![](/images/icons/inline-promo-icon.png)
...
## [](#benefits-of-the-gateway-api)Benefits of the Gateway API
...
## [](#gateway-api-vs-kubernetes-ingress)Gateway API vs Kubernetes Ingress
...
## [](#gateway-api-vs-api-gateway)Gateway API vs API Gateway
...
## [](#how-does-the-gateway-api-work)How Does the Gateway API Work?
...
![Post Image](/images/learn/image-24-1024x792.B_d9O0P_.png)
...
![Post Image](/images/learn/image-25-1024x597.RH4paVnt.png)
...
![Post Image](/images/learn/image-26-1024x536.BHR5eMJj.png)
...
## [](#get-started-with-gateway-api-using-envoy-gateway)Get Started with Gateway API Using Envoy Gateway
