---
title: "What Is mTLS"
description: "Mutual TLS (mTLS) is a variation on transport layer security (TLS). Traditional TLS is the successor to secure sockets layer (SSL) and is the most widely deployed standard for secure communication, most visibly in HTTPS."
categories: ["learn"]
excerpt: "Mutual TLS (mTLS) is a variation on transport layer security (TLS). Traditional TLS is the successor to secure sockets layer (SSL) and is the most widely deployed standard for secure communication, most visibly in HTTPS."
---
...
![Post Image](/images/learn/image.Bjuizrr7.png)
...
![Post Image](/images/learn/image-1-1024x505-1.CF83VIak.png)
...
![Post Image](/images/learn/image-2-1024x313-1.DrvfUkVQ.png)
...
![Post Image](/images/learn/image-3-1024x350-1.oxB8193x.png)
