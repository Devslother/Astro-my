...
description: "Kubernetes is now the leading orchestration platform for deploying and managing containerized applications."
categories: ["learn"]
excerpt: "Kubernetes is now the leading orchestration platform for deploying and managing containerized applications."
---
...
## [](#securing-kubernetes)Securing Kubernetes
...
## [](#how-tetrate-simplifies-kubernetes-security)How Tetrate Simplifies Kubernetes Security
