...
description: "When managing traffic flow in Kubernetes, various ways exist to control routing to pods and other microservices running in a cluster."
categories: ["learn"]
excerpt: "When managing traffic flow in Kubernetes, various ways exist to control routing to pods and other microservices running in a cluster."
---
...
## [](#load-balancers-in-kubernetes)Load Balancers in Kubernetes?
...
## [](#tetrate-simplifies-ingress-and-load-balancing)Tetrate Simplifies Ingress and Load Balancing
