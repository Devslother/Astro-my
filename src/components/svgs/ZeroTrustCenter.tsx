...
const SvgProperty1ZeroTrustCenter = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#Property_1=Zero_Trust_Center_svg__a)">
      <rect
        width={35.07}
        height={39}
        x={12.465}
    ...
    <path
      ...
      strokeWidth={1.5}
      d="M42.002 24.514 30 17l-12.002 7.514z"
    />
    <path
      stroke="#6C6E6F"
      strokeLinecap="round"
      strokeWidth={1.5}
      d="m29.898 27.916-.074 7.185M37.633 27.916l-.074 7.185M22.163 27.916l-.075 7.185"
    />
    <defs>
      <filter
        id="Property_1=Zero_Trust_Center_svg__a"
        width={59.07}
        height={63}
        x={0.465}
        y={0}
      ...
      >
        ...
        <feGaussianBlur
          result="effect1_foregroundBlur_8925_64924"
          stdDeviation={6}
        />
      </filter>
    </defs>
...
export default SvgProperty1ZeroTrustCenter;
