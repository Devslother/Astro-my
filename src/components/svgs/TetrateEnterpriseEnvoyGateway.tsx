...
const SvgProperty1TetrateEnterpriseEnvoyGateway = (
  ...
  >
    <g transform="scale(1.2)">
      ...
      <path
        ...
        stroke="#6C6E6F"
        strokeWidth="0.1"
        d="m30.207 34.851-4.842 2.796 4.842 2.795 4.842-2.795zM35.43 24.926v-6.03l-4.842 2.795v6.031l5.603 3.235v6.03l4.842-2.795v-6.031z"
      />
      <path
        fill="var(--icon-fill, #6C6E6F)"
        stroke="#6C6E6F"
        strokeWidth="0.1"
        d="m24.605 37.207 5.602-3.235 5.222 3.015v-5.591l-5.222-3.015-5.602 3.235-5.223-3.015v5.59z"
      />
      <path
        fill="var(--icon-fill, #6C6E6F)"
        stroke="#6C6E6F"
        strokeWidth="0.1"
        d="m24.605 30.737 5.222-3.015v-6.47l5.223-3.015-4.842-2.795-5.222 3.015v6.47l-5.223 3.014zM36.192 18.896v5.59l4.842 2.796v-5.591z"
      />
      <path
        fill="var(--icon-fill, #6C6E6F)"
        stroke="#6C6E6F"
        strokeWidth="0.1"
        d="M24.224 24.487v-5.591l-4.842 2.795v5.591z"
      />
    </g>
  </svg>
);
export default SvgProperty1TetrateEnterpriseEnvoyGateway;
